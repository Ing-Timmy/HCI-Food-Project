...
<html>
	...
	<body>
		<h1>Food Truck Open Orders</h1></br></br>
		<?php
/*
...
*/
  ...
  // Display orders from orders table who are in the open status
  
  $quest = "select * from orders where status=0 order by oid asc";
  ...
  if($result->num_rows > 0 ){
	  ...
	  echo "<form action='filetohandleopenorders.php' method=post>";
